...
export default function App() {
  ...
  return (
    <ThemeProvider theme={theme}>
      ...
      {step === 0 && <WindowsSelector onSelectOS={handleOSSelection} />}
      {/* PASSO 1: LOADING */}
      {step === 1 && <LoadingScreen onFinish={handleLoadingFinish} />}
      {/* PASSO 2: HACKER LOGIN */}
      {step === 2 && <HackerLoginDemo onFinish={handleLoginFinish} />}
      {/* PASSO 4: APPLICATION */}
      {step === 4 && <Application />}
      {/* PASSO 5: SAFE MODE */}
      {step === 5 && <SafeModeTransition onFinish={handleSafeModeFinish} />}

      {/* 🎵 CONTROLE DE ÁUDIO - montado sempre, visível só no step 3 */}
      <div style={{ pointerEvents: "none", position: "fixed", zIndex: 9999 }}>
